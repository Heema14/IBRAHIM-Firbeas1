...
class Register_user : AppCompatActivity() {
    ...
    private fun validateEmail(): Boolean {
        ...
        if (email.isEmpty()) {
            emailTIL.error = "field_empty"
            return false
        }

        if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
            emailTIL.error = "invalid_email"
            return false
        }
    ...
    private fun validateMobileNum(): Boolean {
        ...
        if (mobileNum.isEmpty()) {
            mobileNumberTIL.error = "field_empty"
            return false
        }

        if (mobileNum.length < 10) {
            mobileNumberTIL.error = "invalid_mobile_no"
            return false
        }
    ...
    private fun validatePassword(): Boolean {
        ...
        if (createPass.isEmpty()) {
            createPasswordTIL.error = "field_empty"
        }

        if (confirmPass.isEmpty()) {
            confirmPasswordTIL.error = "field_empty"
        }
